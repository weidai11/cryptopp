...
void BLAKE2_Compress32_SSE2(const byte* input, BLAKE2_State<word32, false>& state)
{
...
void BLAKE2_Compress64_SSE2(const byte* input, BLAKE2_State<word64, true>& state)
{
