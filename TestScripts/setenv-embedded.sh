...
CFLAGS="${DEF_CFLAGS} ${ARM_EMBEDDED_CFLAGS} --sysroot ${ARM_EMBEDDED_SYSROOT}"
CXXFLAGS="${DEF_CXXFLAGS} ${ARM_EMBEDDED_CXXFLAGS} --sysroot ${ARM_EMBEDDED_SYSROOT}"
LDFLAGS="${DEF_LDFLAGS} ${ARM_EMBEDDED_LDFLAGS}"
